...
do
	...
	for synapses in 1000
	do

		./conn_generator.x $((size/100)) 10 10 $synapses 1

		export OMP_NUM_THREADS=200
		export vtuneCommand="amplxe-cl -c $analysis_type -result-dir vtune_report1_$size -target-system=mic-host-launch:0 --target-install-dir=/gpfs/stfc/local/apps/intel/intel_cs/vtune_amplifier_xe_2015 --"
#		$vtuneCommand mpirun -np 1 -genvall -host $MICNAME ${MYJOB}
		/usr/bin/time -f "Total Time:\t%E\tMem Usage:\t%MkB" mpirun -np 1 -genvall -host $MICNAME ${MYJOB}

		export OMP_NUM_THREADS=100
		export vtuneCommand="amplxe-cl -c $analysis_type -result-dir vtune_report2_$size -target-system=mic-native:0 --target-install-dir=/gpfs/stfc/local/apps/intel/intel_cs/vtune_amplifier_xe_2015 --"
#		$vtuneCommand mpirun -np 2 -genvall -host $MICNAME ${MYJOB}
		/usr/bin/time -f "Total Time:\t%E\tMem Usage:\t%MkB" mpirun -np 2 -genvall -host $MICNAME ${MYJOB}

		export OMP_NUM_THREADS=40
		export vtuneCommand="amplxe-cl -c $analysis_type -result-dir vtune_report5_$size -target-system=mic-host-launch:0 --target-install-dir=/gpfs/stfc/local/apps/intel/intel_cs/vtune_amplifier_xe_2015 --"
#		$vtuneCommand mpirun -np 5 -genvall -host $MICNAME ${MYJOB}
		/usr/bin/time -f "Total Time:\t%E\tMem Usage:\t%MkB" mpirun -np 5 -genvall -host $MICNAME ${MYJOB}

		export OMP_NUM_THREADS=20
		export vtuneCommand="amplxe-cl -c $analysis_type -result-dir vtune_report10_$size -target-system=mic-host-launch:0 --target-install-dir=/gpfs/stfc/local/apps/intel/intel_cs/vtune_amplifier_xe_2015 --"
#		$vtuneCommand mpirun -np 10 -genvall -host $MICNAME ${MYJOB}
		/usr/bin/time -f "Total Time:\t%E\tMem Usage:\t%MkB" mpirun -np 10 -genvall -host $MICNAME ${MYJOB}

		export OMP_NUM_THREADS=10
		export vtuneCommand="amplxe-cl -c $analysis_type -result-dir vtune_report20_$size -target-system=mic-host-launch:0 --target-install-dir=/gpfs/stfc/local/apps/intel/intel_cs/vtune_amplifier_xe_2015 --"
#		$vtuneCommand mpirun -np 20 -genvall -host $MICNAME ${MYJOB}
		/usr/bin/time -f "Total Time:\t%E\tMem Usage:\t%MkB" mpirun -np 20 -genvall -host $MICNAME ${MYJOB}

		export OMP_NUM_THREADS=4
		export vtuneCommand="amplxe-cl -c $analysis_type -result-dir vtune_report50_$size -target-system=mic-host-launch:0 --target-install-dir=/gpfs/stfc/local/apps/intel/intel_cs/vtune_amplifier_xe_2015 --"
#		$vtuneCommand mpirun -np 50 -genvall -host $MICNAME ${MYJOB}
		/usr/bin/time -f "Total Time:\t%E\tMem Usage:\t%MkB" mpirun -np 50 -genvall -host $MICNAME ${MYJOB}
