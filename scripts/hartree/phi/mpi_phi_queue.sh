...
do
	...
	do
		...
		do
			...
			-target-system=mic-host-launch:0 --target-install-dir=/gpfs/stfc/local/apps/intel/intel_cs/vtune_amplifier_xe_2015 --"
#			$vtuneCommand mpirun -np $ranks -genvall -host $MICNAME ${MYJOB}
