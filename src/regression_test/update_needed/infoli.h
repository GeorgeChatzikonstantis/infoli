...
#define COMPRESSED_MAP 0  // a flag denoting whether the connectivity map fed to the simulator is in sparse matrix compression form, 0 for false 1 for true
#define SIMTIME 5  // in ms, for when no input file is provided , time in msec when you do not have an input file
...
#define G_CAL_FROM_FILE 1		//	flag enabling or disabling user defined initial settings of gcal
