...
sending_node* Make_Core_Communication_List_compressed_format (char *, cellCompParams *);
receiving_node* reckon_phase(sending_node *, cellCompParams *);
void perform_communication_step(sending_node *, receiving_node *, cellCompParams *, cellState *, MPI_Request *, MPI_Request *);
void syncing(MPI_Request *);
void cleanup_requests(MPI_Request *);
